...
public:
  virtual const char* classname() const {return "StPicoEvent";}
  StPicoEvent() {}
  ~StPicoEvent() {}
...
// other user's functions
  ...
  int      day() const {return (mRunId%1000000)/1000;}
  float    energy() const { return 200; }
  ...
  bool     isDiMuonHFT() const { return false; }
